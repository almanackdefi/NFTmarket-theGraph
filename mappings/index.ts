...
import {
  ...
  RevenueClaim,
  Trade,
} from "../generated/AlmanackERC721NFTMarketV1/AlmanackERC721NFTMarketV1";
import { toBigDecimal } from "./utils";
import { updateCollectionDayData, updateMarketPlaceDayData } from "./utils/dayUpdates";
import { fetchCollectibleId, fetchName, fetchSymbol, fetchTokenURI } from "./utils/erc721";

// Constants
let ZERO_ADDRESS = "0x0000000000000000000000000000000000000000";
let ALMANACK_COLLECTIBLES_ADDRESS = "0xB4FbA42B523627fb435FD7591e5Dadc0Dc17176b";
...
export function handleAskNew(event: AskNew): void {
  ...
  if (token === null) {
    ...
    if (event.params.collection.equals(Address.fromString(ALMANACK_COLLECTIBLES_ADDRESS))) {
      token.otherId = fetchCollectibleId(event.params.collection, event.params.tokenId);
    }
